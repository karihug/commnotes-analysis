...
def run_scoring():
  ...
  noteParams, helpfulnessScores, newNoteStatusHistory, auxilaryNoteInfo, rater_df  = algorithm.run_algorithm(ratings, noteStatusHistory, userEnrollment)
  process_data.write_scored_notes(noteParams)
  process_data.write_all_outputs(helpfulnessScores,  newNoteStatusHistory,  auxilaryNoteInfo, rater_df)
  print("Finished.")

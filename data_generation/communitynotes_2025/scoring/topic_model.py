...
{
  # ------------------------------------------------------------------
  # Domestic politics, law & government (mostly US-centric)
  # ------------------------------------------------------------------
  Topics.USPolitics: {
    r"biden",
    r"trump",
  ...
  Topics.HealthCovid: {
    ...
    r"mask",
    r"cdc",
    r"who\b",                # avoid matching 'whole', 'whose', etc.
    r"pfizer",
    r"moderna",
  },
  ...
  # Technology & AI
  # ------------------------------------------------------------------
  Topics.ArtificialIntelligence: {
    r"\bai\b",               # word boundary avoids 'said', 'chair'
    r"artificial\sintelligence",
    r"machine\slearning",
    r"chatgpt",
    r"openai",
    r"gpt[-_]?4",
  ...
  # ------------------------------------------------------------------
  # Education, food, space – lighter fare
  # ------------------------------------------------------------------
  Topics.Education: {
    r"student\sloan",
    r"tuition",
...
class TopicModel(object):
  ...
  def validate_note_topic_accuracy_on_seed_labels(self, pred, seedLabels, conflictedTexts):
    ...
    assert balancedAccuracy > 0.01, f"Balanced accuracy too low: {balancedAccuracy}"
